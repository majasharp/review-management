SET_TL_ASSISTANCE_REQUIRED_BY_ID = "UPDATE review SET tl_assistance_required = %s, checked_out_user = %s WHERE id = %s"

ADD_RESPONSE = "INSERT INTO response (body, coupon_id, employee_id, review_id) VALUES(%s, %s, %s, %s)"

SET_CHECKED_OUT_BY_ID = "UPDATE review SET status = %s, checked_out_user = %s WHERE id = %s"

SET_CLOSE_OR_MANUAL_CHECK_BY_ID = "UPDATE review SET status = %s WHERE id = %s"
...
UPDATE_IMPORTANCE_SCORE = "UPDATE review SET importance_score = (%s) WHERE id = (%s)"

CLEAR_CHECKED_OUT_USER_BY_ID = "UPDATE review SET checked_out_user = null where id = %s"
